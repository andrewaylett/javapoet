...
public final class TypeSpecTest {
  ...
  @Test
  public void basic() {
    var taco = TypeSpec.classBuilder("Taco").addMethod(MethodSpec.methodBuilder("toString").addAnnotation(Override.class).addModifiers(Modifier.PUBLIC, Modifier.FINAL).returns(String.class).addCode("return $S;\n", "taco").build()).build();
  ...
  public void interestingTypes() {
    ObjectTypeName listOfAny = ParameterizedTypeName.get(ClassName.get(List.class), WildcardTypeName.subtypeOf(Object.class));
    ObjectTypeName listOfExtends = ParameterizedTypeName.get(ClassName.get(List.class), WildcardTypeName.subtypeOf(Serializable.class));
    ObjectTypeName listOfSuper = ParameterizedTypeName.get(ClassName.get(List.class), WildcardTypeName.supertypeOf(String.class));
    var taco = TypeSpec.classBuilder("Taco").addField(listOfAny, "extendsObject").addField(listOfExtends, "extendsSerializable").addField(listOfSuper, "superString").build();
    assertThat(toString(taco)).isEqualTo("""
            package com.squareup.tacos;
  ...
  public void anonymousInnerClass() {
    ...
    ObjectTypeName thingThangOfFooBar = ParameterizedTypeName.get(thingThang, foo, bar);
    var thung = ClassName.get(tacosPackage, "Thung");
    var simpleThung = ClassName.get(tacosPackage, "SimpleThung");
    ObjectTypeName thungOfSuperBar = ParameterizedTypeName.get(thung, WildcardTypeName.supertypeOf(bar));
    ObjectTypeName thungOfSuperFoo = ParameterizedTypeName.get(thung, WildcardTypeName.supertypeOf(foo));
    ObjectTypeName simpleThungOfBar = ParameterizedTypeName.get(simpleThung, bar);

    var thungParameter = ParameterSpec.builder(thungOfSuperFoo, "thung").addModifiers(Modifier.FINAL).build();
    var aSimpleThung = TypeSpec.anonymousClassBuilder(CodeBlock.of("$N", thungParameter)).superclass(simpleThungOfBar).addMethod(MethodSpec.methodBuilder("doSomething").addAnnotation(Override.class).addModifiers(Modifier.PUBLIC).addParameter(bar, "bar").addCode("/* code snippets */\n").build()).build();
    var aThingThang = TypeSpec.anonymousClassBuilder("").superclass(thingThangOfFooBar).addMethod(MethodSpec.methodBuilder("call").addAnnotation(Override.class).addModifiers(Modifier.PUBLIC).returns(thungOfSuperBar).addParameter(thungParameter).addCode("return $L;\n", aSimpleThung).build()).build();
    var taco = TypeSpec.classBuilder("Taco").addField(FieldSpec.builder(thingThangOfFooBar, "NAME").addModifiers(Modifier.STATIC, Modifier.FINAL, Modifier.FINAL).initializer("$L", aThingThang).build()).build();
  ...
  public void annotationsAndJavaLangTypes() {
    ...
    var taco = TypeSpec.classBuilder("EthicalTaco").addField(ClassName.get(String.class).annotated(AnnotationSpec.builder(freeRange).build()), "meat").build();
  ...
  public void annotatedField() {
    var taco = TypeSpec.classBuilder("Taco").addField(FieldSpec.builder(String.class, "thing", Modifier.PRIVATE, Modifier.FINAL).addAnnotation(AnnotationSpec.builder(ClassName.get(tacosPackage, "JsonAdapter")).addMember("value", "$T.class", ClassName.get(tacosPackage, "Foo")).build()).build()).build();
    assertThat(toString(taco)).isEqualTo("""
            package com.squareup.tacos;
  ...
  public void annotatedClass() {
    ...
    var taco = TypeSpec.classBuilder("Foo").addAnnotation(AnnotationSpec.builder(ClassName.get(tacosPackage, "Something")).addMember("hi", "$T.$N", someType, "FIELD").addMember("hey", "$L", 12).addMember("hello", "$S", "goodbye").build()).addModifiers(Modifier.PUBLIC).build();
    assertThat(toString(taco)).isEqualTo("""
            package com.squareup.tacos;
  ...
  public void enumsMayDefineAbstractMethods() {
    var roshambo = TypeSpec.enumBuilder("Tortilla").addModifiers(Modifier.PUBLIC).addEnumConstant("CORN", TypeSpec.anonymousClassBuilder("").addMethod(MethodSpec.methodBuilder("fold").addAnnotation(Override.class).addModifiers(Modifier.PUBLIC).build()).build()).addMethod(MethodSpec.methodBuilder("fold").addModifiers(Modifier.PUBLIC, Modifier.ABSTRACT).build()).build();
    assertThat(toString(roshambo)).isEqualTo("""
            package com.squareup.tacos;
  ...
  public void noEnumConstants() {
    var roshambo = TypeSpec.enumBuilder("Roshambo").addField(String.class, "NO_ENUM", Modifier.STATIC).build();
    assertThat(toString(roshambo)).isEqualTo("""
            package com.squareup.tacos;
  ...
  public void enumWithMembersButNoConstructorCall() {
    var roshambo = TypeSpec.enumBuilder("Roshambo").addEnumConstant("SPOCK", TypeSpec.anonymousClassBuilder("").addMethod(MethodSpec.methodBuilder("toString").addAnnotation(Override.class).addModifiers(Modifier.PUBLIC).returns(String.class).addCode("return $S;\n", "west side").build()).build()).build();
    assertThat(toString(roshambo)).isEqualTo("""
            package com.squareup.tacos;
  ...
  public void enumWithAnnotatedValues() {
    var roshambo = TypeSpec.enumBuilder("Roshambo").addModifiers(Modifier.PUBLIC).addEnumConstant("ROCK", TypeSpec.anonymousClassBuilder("").addAnnotation(Deprecated.class).build()).addEnumConstant("PAPER").addEnumConstant("SCISSORS").build();
    assertThat(toString(roshambo)).isEqualTo("""
            package com.squareup.tacos;
  ...
  public void typeVariableWithBounds() {
    var a = AnnotationSpec.builder(ClassName.get("com.squareup.tacos", "A")).build();
    var p = TypeVariableName.get("P", Number.class);
    var q = TypeVariableName.get("Q", Number.class).annotated(a);
    var typeSpec = TypeSpec.classBuilder("Location").addTypeVariable(p.withBounds(Comparable.class)).addTypeVariable(q.withBounds(Comparable.class)).addField(p, "x").addField(q, "y").build();
    assertThat(toString(typeSpec)).isEqualTo("""
            package com.squareup.tacos;
  ...
  public void classImplementsExtends() {
    ...
    var typeSpec = TypeSpec.classBuilder("Taco").addModifiers(Modifier.ABSTRACT).superclass(ParameterizedTypeName.get(ClassName.get(AbstractSet.class), food)).addSuperinterface(Serializable.class).addSuperinterface(ParameterizedTypeName.get(ClassName.get(Comparable.class), taco)).build();
    assertThat(toString(typeSpec)).isEqualTo("""
            package com.squareup.tacos;
  ...
  public void classImplementsNestedClass() {
    ...
    var typeSpec = TypeSpec.classBuilder("Outer").superclass(ParameterizedTypeName.get(callable, inner)).addType(TypeSpec.classBuilder("Inner").addModifiers(Modifier.STATIC).build()).build();
  ...
  public void enumImplements() {
    var typeSpec = TypeSpec.enumBuilder("Food").addSuperinterface(Serializable.class).addSuperinterface(Cloneable.class).addEnumConstant("LEAN_GROUND_BEEF").addEnumConstant("SHREDDED_CHEESE").build();
    assertThat(toString(typeSpec)).isEqualTo("""
            package com.squareup.tacos;
  ...
  public void interfaceExtends() {
    var taco = ClassName.get(tacosPackage, "Taco");
    var typeSpec = TypeSpec.interfaceBuilder("Taco").addSuperinterface(Serializable.class).addSuperinterface(ParameterizedTypeName.get(ClassName.get(Comparable.class), taco)).build();
    assertThat(toString(typeSpec)).isEqualTo("""
            package com.squareup.tacos;
  ...
  public void annotation() throws Exception {
    var annotation = TypeSpec.annotationBuilder("MyAnnotation").addModifiers(Modifier.PUBLIC).addMethod(MethodSpec.methodBuilder("test").addModifiers(Modifier.PUBLIC, Modifier.ABSTRACT).defaultValue("$L", 0).returns(int.class).build()).build();
  ...
  public void innerAnnotationInAnnotationDeclaration() {
    var bar = TypeSpec.annotationBuilder("Bar").addMethod(MethodSpec.methodBuilder("value").addModifiers(Modifier.PUBLIC, Modifier.ABSTRACT).defaultValue("@$T", Deprecated.class).returns(Deprecated.class).build()).build();
  ...
  public void annotationWithFields() {
    var field = FieldSpec.builder(int.class, "FOO").addModifiers(Modifier.PUBLIC, Modifier.STATIC, Modifier.FINAL).initializer("$L", 101).build();
  ...
  public void interfaceStaticMethods() {
    var bar = TypeSpec.interfaceBuilder("Tacos").addMethod(MethodSpec.methodBuilder("test").addModifiers(Modifier.PUBLIC, Modifier.STATIC).returns(int.class).addCode(CodeBlock.builder().addStatement("return 0").build()).build()).build();
  ...
  public void interfaceDefaultMethods() {
    var bar = TypeSpec.interfaceBuilder("Tacos").addMethod(MethodSpec.methodBuilder("test").addModifiers(Modifier.PUBLIC, Modifier.DEFAULT).returns(int.class).addCode(CodeBlock.builder().addStatement("return 0").build()).build()).build();
  ...
  public void interfacePrivateMethods() {
    var bar = TypeSpec.interfaceBuilder("Tacos").addMethod(MethodSpec.methodBuilder("test").addModifiers(Modifier.PRIVATE).returns(int.class).addCode(CodeBlock.builder().addStatement("return 0").build()).build()).build();
  ...
  public void referencedAndDeclaredSimpleNamesConflict() {
    var internalTop = FieldSpec.builder(ClassName.get(tacosPackage, "Top"), "internalTop").build();
    var internalBottom = FieldSpec.builder(ClassName.get(tacosPackage, "Top", "Middle", "Bottom"), "internalBottom").build();
    var externalTop = FieldSpec.builder(ClassName.get(donutsPackage, "Top"), "externalTop").build();
    var externalBottom = FieldSpec.builder(ClassName.get(donutsPackage, "Bottom"), "externalBottom").build();
    var top = TypeSpec.classBuilder("Top").addField(internalTop).addField(internalBottom).addField(externalTop).addField(externalBottom).addType(TypeSpec.classBuilder("Middle").addField(internalTop).addField(internalBottom).addField(externalTop).addField(externalBottom).addType(TypeSpec.classBuilder("Bottom").addField(internalTop).addField(internalBottom).addField(externalTop).addField(externalBottom).build()).build()).build();
  ...
  public void simpleNamesConflictInThisAndOtherPackage() {
    var internalOther = FieldSpec.builder(ClassName.get(tacosPackage, "Other"), "internalOther").build();
    var externalOther = FieldSpec.builder(ClassName.get(donutsPackage, "Other"), "externalOther").build();
    var gen = TypeSpec.classBuilder("Gen").addField(internalOther).addField(externalOther).build();
  ...
  public void originatingElementsIncludesThoseOfNestedTypes() {
    ...
    var outer = TypeSpec.classBuilder("Outer").addOriginatingElement(outerElement).addType(TypeSpec.classBuilder("Inner").addOriginatingElement(innerElement).build()).build();
  ...
  public void intersectionType() {
    ...
    var taco = TypeSpec.classBuilder("Taco").addMethod(MethodSpec.methodBuilder("getComparator").addTypeVariable(typeVariable).returns(typeVariable).addCode("return null;\n").build()).build();
    assertThat(toString(taco)).isEqualTo("""
            package com.squareup.tacos;
  ...
  public void arrayType() {
    var taco = TypeSpec.classBuilder("Taco").addField(int[].class, "ints").build();
    assertThat(toString(taco)).isEqualTo("""
            package com.squareup.tacos;
  ...
  @Test
  public void varargs() {
    var taqueria = TypeSpec.classBuilder("Taqueria").addMethod(MethodSpec.methodBuilder("prepare").addParameter(int.class, "workers").addParameter(Runnable[].class, "jobs").varargs().build()).build();
  ...
  public void codeBlocks() {
    var ifBlock = CodeBlock.builder().beginControlFlow("if (!a.equals(b))").addStatement("return i").endControlFlow().build();
    var methodBody = CodeBlock.builder().addStatement("$T size = $T.min(listA.size(), listB.size())", int.class, Math.class).beginControlFlow("for ($T i = 0; i < size; i++)", int.class).addStatement("$T $N = $N.get(i)", String.class, "a", "listA").addStatement("$T $N = $N.get(i)", String.class, "b", "listB").add("$L", ifBlock).endControlFlow().addStatement("return size").build();
    var fieldBlock = CodeBlock.builder().add("$>$>").add("\n$T.<$T, $T>builder()$>$>", ImmutableMap.class, String.class, String.class).add("\n.add($S, $S)", '\'', "&#39;").add("\n.add($S, $S)", '&', "&amp;").add("\n.add($S, $S)", '<', "&lt;").add("\n.add($S, $S)", '>', "&gt;").add("\n.build()$<$<").add("$<$<").build();
    var escapeHtml = FieldSpec.builder(ParameterizedTypeName.get(Map.class, String.class, String.class), "ESCAPE_HTML").addModifiers(Modifier.PRIVATE, Modifier.STATIC, Modifier.FINAL).initializer(fieldBlock).build();
    var util = TypeSpec.classBuilder("Util").addField(escapeHtml).addMethod(MethodSpec.methodBuilder("commonPrefixLength").returns(int.class).addParameter(ParameterizedTypeName.get(List.class, String.class), "listA").addParameter(ParameterizedTypeName.get(List.class, String.class), "listB").addCode(methodBody).build()).build();
  ...
  @Test
  public void elseIf() {
    var taco = TypeSpec.classBuilder("Taco").addMethod(MethodSpec.methodBuilder("choices").beginControlFlow("if (5 < 4) ").addStatement("$T.out.println($S)", System.class, "wat").nextControlFlow("else if (5 < 6)").addStatement("$T.out.println($S)", System.class, "hello").endControlFlow().build()).build();
    assertThat(toString(taco)).isEqualTo("""
            package com.squareup.tacos;
  ...
  @Test
  public void doWhile() {
    var taco = TypeSpec.classBuilder("Taco").addMethod(MethodSpec.methodBuilder("loopForever").beginControlFlow("do").addStatement("$T.out.println($S)", System.class, "hello").endControlFlow("while (5 < 6)").build()).build();
    assertThat(toString(taco)).isEqualTo("""
            package com.squareup.tacos;
  ...
  public void inlineIndent() {
    var taco = TypeSpec.classBuilder("Taco").addMethod(MethodSpec.methodBuilder("inlineIndent").addCode("if (3 < 4) {\n$>$T.out.println($S);\n$<}\n", System.class, "hello").build()).build();
    assertThat(toString(taco)).isEqualTo("""
            package com.squareup.tacos;
  ...
  public void defaultModifiersForMemberInterfacesAndEnums() {
    var taco = TypeSpec.classBuilder("Taco").addType(TypeSpec.classBuilder("Meat").addModifiers(Modifier.STATIC).build()).addType(TypeSpec.interfaceBuilder("Tortilla").addModifiers(Modifier.STATIC).build()).addType(TypeSpec.enumBuilder("Topping").addModifiers(Modifier.STATIC).addEnumConstant("SALSA").build()).build();
    assertThat(toString(taco)).isEqualTo("""
            package com.squareup.tacos;
  ...
  public void nativeMethods() {
    var taco = TypeSpec.classBuilder("Taco").addMethod(MethodSpec.methodBuilder("nativeInt").addModifiers(Modifier.NATIVE).returns(int.class).build())
            // GWT JSNI
  ...
  public void nullStringLiteral() {
    var taco = TypeSpec.classBuilder("Taco").addField(FieldSpec.builder(String.class, "NULL").initializer("$S", (Object) null).build()).build();
    assertThat(toString(taco)).isEqualTo("""
            package com.squareup.tacos;
  ...
  public void annotationToString() {
    var annotation = AnnotationSpec.builder(SuppressWarnings.class).addMember("value", "$S", "unused").build();
    assertThat(annotation.toString()).isEqualTo("@java.lang.SuppressWarnings(\"unused\")");
  }

  @Test
  public void codeBlockToString() {
    var codeBlock = CodeBlock.builder().addStatement("$T $N = $S.substring(0, 3)", String.class, "s", "taco").build();
  ...
  public void fieldToString() {
    var field = FieldSpec.builder(String.class, "s", Modifier.FINAL).initializer("$S.substring(0, 3)", "taco").build();
    assertThat(field.toString()).isEqualTo("final java.lang.String s = \"taco\".substring(0, 3);\n");
  }

  @Test
  public void methodToString() {
    var method = MethodSpec.methodBuilder("toString").addAnnotation(Override.class).addModifiers(Modifier.PUBLIC).returns(String.class).addStatement("return $S", "taco").build();
  ...
  public void constructorToString() {
    var constructor = MethodSpec.constructorBuilder().addModifiers(Modifier.PUBLIC).addParameter(ClassName.get(tacosPackage, "Taco"), "taco").addStatement("this.$N = $N", "taco", "taco").build();
  ...
  public void parameterToString() {
    var parameter = ParameterSpec.builder(ClassName.get(tacosPackage, "Taco"), "taco").addModifiers(Modifier.FINAL).addAnnotation(ClassName.get("javax.annotation", "Nullable")).build();
  ...
  public void anonymousClassToString() {
    var type = TypeSpec.anonymousClassBuilder("").addSuperinterface(Runnable.class).addMethod(MethodSpec.methodBuilder("run").addAnnotation(Override.class).addModifiers(Modifier.PUBLIC).build()).build();
    assertThat(type.toString()).isEqualTo("""
  ...
  public void multilineStatement() {
    var taco = TypeSpec.classBuilder("Taco").addMethod(MethodSpec.methodBuilder("toString").addAnnotation(Override.class).addModifiers(Modifier.PUBLIC).returns(String.class).addStatement("return $S\n+ $S\n+ $S\n+ $S\n+ $S", "Taco(", "beef,", "lettuce,", "cheese", ")").build()).build();
    assertThat(toString(taco)).isEqualTo("""
            package com.squareup.tacos;
  ...
  public void multilineStatementWithAnonymousClass() {
    ObjectTypeName stringComparator = ParameterizedTypeName.get(Comparator.class, String.class);
    ObjectTypeName listOfString = ParameterizedTypeName.get(List.class, String.class);
    var prefixComparator = TypeSpec.anonymousClassBuilder("").addSuperinterface(stringComparator).addMethod(MethodSpec.methodBuilder("compare").addAnnotation(Override.class).addModifiers(Modifier.PUBLIC).returns(int.class).addParameter(String.class, "a").addParameter(String.class, "b").addStatement("return a.substring(0, length)\n" + ".compareTo(b.substring(0, length))").build()).build();
    var taco = TypeSpec.classBuilder("Taco").addMethod(MethodSpec.methodBuilder("comparePrefix").returns(stringComparator).addParameter(int.class, "length", Modifier.FINAL).addStatement("return $L", prefixComparator).build()).addMethod(MethodSpec.methodBuilder("sortPrefix").addParameter(listOfString, "list").addParameter(int.class, "length", Modifier.FINAL).addStatement("$T.sort(\nlist,\n$L)", Collections.class, prefixComparator).build()).build();
    assertThat(toString(taco)).isEqualTo("""
            package com.squareup.tacos;
  ...
  public void multilineStrings() {
    var taco = TypeSpec.classBuilder("Taco").addField(FieldSpec.builder(String.class, "toppings").initializer("$S", "shell\nbeef\nlettuce\ncheese\n").build()).build();
    assertThat(toString(taco)).isEqualTo("""
            package com.squareup.tacos;
  ...
  public void nullAnnotationsAddition() {
    var expected = assertThrows(IllegalArgumentException.class, () -> classBuilder("Taco").addAnnotations(null));
    assertThat(expected.getMessage()).contains("annotationSpecs");
  }

  @Test
  public void multipleAnnotationAddition() {
    var taco = TypeSpec.classBuilder("Taco").addAnnotations(Arrays.asList(AnnotationSpec.builder(SuppressWarnings.class).addMember("value", "$S", "unchecked").build(), AnnotationSpec.builder(Deprecated.class).build())).build();
    assertThat(toString(taco)).isEqualTo("""
            package com.squareup.tacos;
  ...
  public void nullFieldsAddition() {
    var expected = assertThrows(IllegalArgumentException.class, () -> classBuilder("Taco").addFields(null));
    assertThat(expected.getMessage()).contains("fieldSpecs");
  }

  @Test
  public void multipleFieldAddition() {
    var taco = TypeSpec.classBuilder("Taco").addFields(Arrays.asList(FieldSpec.builder(int.class, "ANSWER", Modifier.STATIC, Modifier.FINAL).build(), FieldSpec.builder(BigDecimal.class, "price", Modifier.PRIVATE).build())).build();
    assertThat(toString(taco)).isEqualTo("""
            package com.squareup.tacos;
  ...
  public void nullMethodsAddition() {
    var expected = assertThrows(IllegalArgumentException.class, () -> classBuilder("Taco").addMethods(null));
  ...
  public void nullSuperinterfacesAddition() {
    var expected = assertThrows(IllegalArgumentException.class, () -> classBuilder("Taco").addSuperinterfaces(null));
    assertThat(expected.getMessage()).contains("superinterfaces");
  }

  @Test
  public void nullSingleSuperinterfaceAddition() {
    var expected = assertThrows(IllegalArgumentException.class, () -> classBuilder("Taco").addSuperinterface((ObjectTypeName) null));
  ...
  public void nullInSuperinterfaceIterableAddition() {
    ...
    var expected = assertThrows(IllegalArgumentException.class, () -> classBuilder("Taco").addSuperinterfaces(superinterfaces));
    assertThat(expected.getMessage()).contains("superinterface");
  }
  ...
  public void nullModifiersAddition() {
    var expected = assertThrows(IllegalArgumentException.class, () -> classBuilder("Taco").addModifiers((Modifier) null).build());
    assertThat(expected.getMessage()).isEqualTo("modifiers contain null");
  }

  @Test
  public void nullTypeVariablesAddition() {
    var expected = assertThrows(IllegalArgumentException.class, () -> classBuilder("Taco").addTypeVariables(null));
  ...
  public void nullTypesAddition() {
    var expected = assertThrows(IllegalArgumentException.class, () -> classBuilder("Taco").addTypes(null));
  ...
  public void tryCatch() {
    var taco = TypeSpec.classBuilder("Taco").addMethod(MethodSpec.methodBuilder("addTopping").addParameter(ClassName.get("com.squareup.tacos", "Topping"), "topping").beginControlFlow("try").addCode("/* do something tricky with the topping */\n").nextControlFlow("catch ($T e)", ClassName.get("com.squareup.tacos", "IllegalToppingException")).endControlFlow().build()).build();
    assertThat(toString(taco)).isEqualTo("""
            package com.squareup.tacos;
  ...
  @Test
  public void ifElse() {
    var taco = TypeSpec.classBuilder("Taco").addMethod(MethodSpec.methodBuilder("isDelicious").addParameter(PrimitiveType.Integer, "count").returns(PrimitiveType.Boolean).beginControlFlow("if (count > 0)").addStatement("return true").nextControlFlow("else").addStatement("return false").endControlFlow().build()).build();
    assertThat(toString(taco)).isEqualTo("""
            package com.squareup.tacos;
  ...
  public void nameFromMethod() {
    var method = MethodSpec.methodBuilder("method").addModifiers(Modifier.ABSTRACT).returns(String.class).build();
  ...
  public void nameFromUnsupportedType() {
    var expected = assertThrows(IllegalArgumentException.class, () -> builder().add("$N", String.class));
  ...
  public void typeFromUnsupportedType() {
    var expected = assertThrows(IllegalArgumentException.class, () -> builder().add("$T", "java.lang.String"));
    assertThat(expected).hasMessageThat().isEqualTo("expected type but was a class java.lang.String");
  }

  @Test
  public void tooFewArguments() {
    var expected = assertThrows(IllegalArgumentException.class, () -> builder().add("$S"));
  ...
  public void unusedArgumentsRelative() {
    var expected = assertThrows(IllegalArgumentException.class, () -> builder().add("$L $L", "a", "b", "c"));
    assertThat(expected).hasMessageThat().isEqualTo("unused arguments: expected 2, received 3");
  }

  @Test
  public void unusedArgumentsIndexed() {
    var expected = assertThrows(IllegalArgumentException.class, () -> builder().add("$1L $2L", "a", "b", "c"));
    assertThat(expected).hasMessageThat().isEqualTo("unused argument: $3");
    var expected = assertThrows(IllegalArgumentException.class, () -> builder().add("$1L $1L $1L", "a", "b", "c"));
    assertThat(expected).hasMessageThat().isEqualTo("unused arguments: $2, $3");
    var expected = assertThrows(IllegalArgumentException.class, () -> builder().add("$3L $1L $3L $1L $3L", "a", "b", "c", "d"));
  ...
  public void initializersToBuilder() {
    ...
    var initializersAdded = taco.toBuilder().addInitializerBlock(CodeBlock.builder().addStatement("foo = $S", "instanceFoo").build()).addStaticBlock(CodeBlock.builder().addStatement("FOO = $S", "staticFoo").build()).build();
  ...
  public void lineWrapping() {
    ...
    var taco = TypeSpec.classBuilder("Taco").addMethod(methodBuilder.build()).build();
    assertThat(toString(taco)).isEqualTo("""
            package com.squareup.tacos;
  ...
  public void lineWrappingWithZeroWidthSpace() {
    var method = MethodSpec.methodBuilder("call").addCode("$[iAmSickOfWaitingInLine($Z").addCode("it, has, been, far, too, long, of, a, wait, and, i, would, like, to, eat, ").addCode("this, is, a, run, on, sentence").addCode(");$]\n").build();
  ...
  public void modifyAnnotations() {
    var builder = TypeSpec.classBuilder("Taco").addAnnotation(Override.class).addAnnotation(SuppressWarnings.class);
  ...
  public void modifyModifiers() {
    var builder = TypeSpec.classBuilder("Taco").addModifiers(Modifier.PUBLIC, Modifier.FINAL);
  ...
  public void modifyTypeVariables() {
    var t = TypeVariableName.get("T");
    var builder = TypeSpec.classBuilder("Taco").addTypeVariable(t).addTypeVariable(TypeVariableName.get("V"));
  ...
  public void modifyMethods() {
    var builder = TypeSpec.classBuilder("Taco").addMethod(MethodSpec.methodBuilder("bell").build());
  ...
  public void modifyTypes() {
    var builder = TypeSpec.classBuilder("Taco").addType(TypeSpec.classBuilder("Bell").build());
  ...
  public void modifyEnumConstants() {
    ...
    var builder = TypeSpec.enumBuilder("Taco").addEnumConstant("BELL", constantType).addEnumConstant("WUT", TypeSpec.anonymousClassBuilder("").build());
  ...
  public void modifyOriginatingElements() {
    var builder = TypeSpec.classBuilder("Taco").addOriginatingElement(Mockito.mock(Element.class));
  ...
  public void javadocWithTrailingLineDoesNotAddAnother() {
    var spec = TypeSpec.classBuilder("Taco").addJavadoc("Some doc with a newline\n").build();
  ...
  public void javadocEnsuresTrailingLine() {
    var spec = TypeSpec.classBuilder("Taco").addJavadoc("Some doc with a newline").build();
